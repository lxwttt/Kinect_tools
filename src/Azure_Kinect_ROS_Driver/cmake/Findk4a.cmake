...
if(NOT _depthengine_bin)
    message(STATUS "Could not find depth engine in ./ext/sdk! Rejecting ext/sdk")
else()
    ...
    if(${k4a_FOUND} AND ${k4arecord_FOUND})
        ...
        message(STATUS "Found an Azure Kinect SDK in ./ext/sdk")
        ...
        message(STATUS "Accepted SDK in ./ext/sdk. System paths will not be searched")
        return()
    else()
        message(STATUS "No Azure Kinect SDK found in ./ext/sdk")
    endif()
endif()
